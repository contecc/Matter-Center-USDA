...
namespace Microsoft.Legal.MatterCenter.Web.Common
{
    public class KeyVaultHelper
    {
        ...
        /// </summary>
        /// <param name="configuration"></param>
        public static void GetCert(IConfiguration configuration)
        {
            var clientAssertionCertPfx = CertificateHelper.FindCertificateByThumbprint(configuration["General:KeyVaultCertThumbPrint"].ToString());
            AssertionCert = new ClientAssertionCertificate(configuration["General:KeyVaultClientID"], clientAssertionCertPfx);
        }
