    ...
    public class MatterProvision : IMatterProvision
    {
        ...
        public GenericResponseVM UpdateMatter(MatterInformationVM matterInformation)
        {
            ...
            try
            {
                ...
                //editFunctions.ValidateFullControlPermission(matter);
        ...
        /// <summary>
        /// This method will remove the user from the given matter name
        /// </summary>
        ...
        private void ShareMatterToExtUser(MatterInformationVM matterInformation)
        {
            ...
            for (int i = 0; i < matterInformation.Matter.AssignUserNames.Count; i++)
            {
                ...
                {
                    if (!string.IsNullOrWhiteSpace(matterInformation.Matter.AssignUserNames[i].ToString()))
                    {
